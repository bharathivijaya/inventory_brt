...
<table class="table table-striped" id="myTable">
    ...
    <tr>
        ...
        <td><?=$one['d_onHand']?></td>
        <td><a href="<?=base_url()?>drug/view_drug/<?=$one['d_id']?>">Edit</a></td>
    </tr>
    <?}?>
    </tbody>
</table>
...
<script>
    $(document).ready(function(){
        $('#myTable').DataTable(
			{
				"aoColumnDefs": [
					{ "sWidth": "100px", "type": "phoneNumber", "aTargets": [1] },
        ...
        $('#myTable_filter').after('<div id="after_filter"><a href="<?=base_url()?>drug/drug_catalog" class="btn btn-warning" style="line-height: 0.9">New drug</a></div>');
    });
</script>